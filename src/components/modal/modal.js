...
class Modal extends Component{
    ...
    addStock = () =>{
        ...
        if(document.getElementById("noShares").value==='' || document.getElementById("buyPrice").value===''
            ...
            axios.post('https://financial-portfolio-app.firebaseio.com/mystocks.json',{
            ...
            axios.delete(`https://financial-portfolio-app.firebaseio.com/tickers.json/${this.props.stockKey}.json`);
            ...
            <div>
                ...
                <div style={{height: '500px', textAlign: 'center', position: 'fixed', 
                        ...
                        <form className='formStyle'>
                            ...
                            <label htmlFor='name'> <strong>Current Price  </strong></label> : <strong>{this.props.currentPrice}</strong><br/><br/>
                        ...
                        <button type='button' className='AddButton' style={{backgroundColor:"gray",height:"10px",textAlign:"center",paddingTop:"2px",color:"white"}} id='addForm' onClick={this.addStock}>Add</button>
                       <button type="button" className='closeButton' style={{backgroundColor:"black",height:"10px",textAlign:"center",paddingTop:"2px",color:"white"}} id="closeBtn" onClick={this.closeModal}>Close</button><br/><br/>
                       <div id="errorMsg"></div>
                 </div>
            </div>
        )
